...
class SearchQueryPageSearchBar extends React.Component {
  ...
  render() {
    var loggedin="Login";
    var useradmin=this.props.useradmin.adminuser;
    
    if(useradmin && useradmin._id){
      loggedin="Logout ("+useradmin.name+")";
    }
...
export default SearchQueryPageSearchBar;
